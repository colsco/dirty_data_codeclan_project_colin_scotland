...
countries <- countries %>% 
  mutate(country = str_replace_all(country, pattern = "[Ee]n[dg]land|Scotland|(?i)u[:punct:]*k[:punct:]*|(?i)united king*dom", "Great Britain")) 
...
the number of imperfectly tidied country names is a very small part of the overall and should not influence the
results too much.
...
**UK:**     lindt truffle	                        30 votes

**Canada:** kit kat	                             233 votes

**Other:**  kit kat	                              61 votes	