...
and although the first attempt performed perfectly well, the coding for the function ended up 
being longer than the coding for the original analysis and didn't provide any real advantage.

Shortening the function worked up to a point, but isn't returning expected results at the time
of submission to Github.
...
*The function works as expected, - but in this case the function is longer than the*
*original code, so I didn't gain anything.*

*I tried to streamline the function and just about got there, but can't get the result*
*to return properly - see below.*

```{r}
# first attempt at function - wraps above code into a function framework - works ok,  but very verbose!

#gender_joy <- function(gender) {
  
#   if(!is.character(gender)) { # control non-character entries
...
#      gender != "other" & gender != "Other" & gender != "OTHER" &
#      gender != "na" & gender != "Na" & gender != "NA" &
...
#  return(slice_max(male_favourite, order_by = "q6_male", n = 1))
...
#  return(slice_max(female_favourite, order_by = "q6_female", n = 1))
  
#  }
  
#  if(gender == "other" | gender == "Other" | gender == "OTHER")  {
...
#  return(slice_max(other_favourite, order_by = "q6_other", n = 1))
...
#  return(slice_max(nosay_favourite, order_by = "q6_nosay", n = 1))
  
#  }
  
#  if(gender == "na" | gender == "Na" | gender == "NA")  {
...
#  return(slice_max(na_favourite, order_by = "q6_male", n = 1))
...
Do some testing on the function;
...
#  return(slice_max(q6_joy, order_by = "total_joy", n = 2))
