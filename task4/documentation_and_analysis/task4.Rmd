...
Shortening the function worked up to a point, but wasn't successful in returning results before
the project had to be submitted.
...
#  summarise(total_joy = sum(as.integer(value_numeric))) %>% 
