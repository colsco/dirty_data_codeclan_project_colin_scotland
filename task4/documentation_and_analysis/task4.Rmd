...
cleaning script can be found in the *cleaning_script* folder and runs the following;
...
It should be noted that in the UK, rolos and toblerone also scored 30 votes, so there was a tie for first place.
